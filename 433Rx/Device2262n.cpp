...
void Device2262n::processPulse(long duration) {
...
bool Device2262n::registerMessageHandler(Device2262nMessageHandler* handler) {
...
void Device2262n::handleMessage(Message* message) {
